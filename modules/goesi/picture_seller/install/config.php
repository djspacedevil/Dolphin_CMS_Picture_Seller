...
$aConfig = array(
	 ...
	 * Main Section.
	 */	
	'title' => 'Picture Seller', // module title, this name will be displayed in the modules list
	 ...
	 */
	'home_dir' => 'goesi/picture_seller/', // folder where module files are located, it describes path from /modules/ folder.
	'home_uri' => 'picture_seller', // module URI, so the module will be accessable via the following urls: m/bloggie/ or modules/?r=bloggie/
	
	'db_prefix' => 'goesi_pic_sell_', // database prefix for all module tables, it is better to compose it from vendor prefix + module prefix, in out case it is me (vendor prefix) and blgg(Bloggie module prefix)
    'class_prefix' => 'GoesiSell', // class prefix for all module classes, it is better to compose it from vendor prefix + module prefix, in out case it is Me (vendor prefix) and Blgg(Bloggie module prefix)
	 ...
	 */
	'language_category' => 'Picture Seller',
